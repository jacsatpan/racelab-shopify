  ...
  Cart.prototype = _.assignIn({}, Cart.prototype, {
    ...
    _liveRegionText: function(item) {
      ...
      var regularPrice = theme.Currency.formatMoney(
        item.original_line_price*1.15, item.original_line_price,
        theme.moneyFormat
      );
      var discountLabel = '';
      var discountPrice = '';
...
theme.init = function() {
  ...
  $('.tab').on('click', (evt) => {
    $(evt.currentTarget).find('.tab-content').toggleClass('visible');
  });

//   const nav = $('#site-nav-custom');
//   const overlay = $('#site-nav-custom--overlay');
...
//       } else {
//             nav.addClass('is-open').css('top', headerHeight);
//             overlay.addClass('is-active').css('top', headerHeight);
//             $('html, body').css('overflow', 'hidden');
//       }
//   }

//   $('#shopLink').on('click', toggleCustomMenu);
//   overlay.on('click', toggleCustomMenu);
};
